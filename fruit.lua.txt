--- RTaO Dev BloxFruit Script Test V1.2
...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading RTaO Dev...")
...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/RTaOexe1/rtao_dev/main/RTaO_UI_1.lua")))();
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("RTaO Dev/Blox Fruits/") then
			makefolder("RTaO Dev/Blox Fruits/");
		end;
		if not isfile(("RTaO Dev/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("RTaO Dev/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("RTaO Dev/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("RTaO Dev/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("RTaO Dev/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
...
spawn(function()
	...
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Yellow>[ Enjoy for script By RTaO ]<Color=/>")):Display();
end);
function CheckQuest()
