...
loadstring(game:HttpGet('https://raw.githubusercontent.com/RTaOexe1/Script/refs/heads/main/AutoFramGem.lua'))()
]])
...
if tonumber(game.PlaceId) == tonumber(79546208627805) then
	...
	if TeleporterAssets:WaitForChild("Frame") then
		...
		if Frame:FindFirstChild("TextLabel1") then
			...
			TextLabel1.Text = "Auto-Farm Gem | RTaO Dev"
		...
		if Frame:FindFirstChild("TextLabel2") then
			...
			TextLabel2.Text = "RTaO Dev (dsc.gg/EH23mXVqce)"
