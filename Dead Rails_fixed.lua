...
local Window = Rayfield:CreateWindow({
    Name = " RTaO Dev - Dead Rails",
    LoadingTitle = "RTaO Dev Loaded",
...
InfoTab:CreateParagraph({
    Title = "Welcome",
    Content = "Made by RTaO. Free script, f*** paid cheats."
})
...
name.Center = true
name.Outline = true
name.Color = espSettings.NameColorSettings.NameColor
