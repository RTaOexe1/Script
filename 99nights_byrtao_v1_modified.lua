...
createNotif("RTaO", "Welcome to 99 Nights in the Forest Enjoy the Freemium Scripts!", 10)
...
local Window = Fluent:CreateWindow({
    Title = "99 Nights in the forest | By RTaO",
    SubTitle = "",
    TabWidth = 100,
...
local BunnyESPToggle = Tabs.Esp:AddToggle("BunnyESP", {
    ...
    Callback = function(Value)
        ...
        if not Value then
            ...
            createNotif("RTaO", "Bunny ESP Off", 2)
        else
            createNotif("RTaO", "Bunny ESP On", 2)
            scanForBunnies()
        end
    end
})
 ...
 local WolfESPToggle = Tabs.Esp:AddToggle("WolfESP", {
    ...
    Callback = function(Value)
        ...
        if not Value then
            ...
            createNotif("RTaO", "Wolf ESP Off", 2)
        else
            createNotif("RTaO", "Wolf ESP On", 2)
            scanForWolves()
        end
    end
})
...
local DeerESPToggle = Tabs.Esp:AddToggle("DeerESP", {
    ...
    Callback = function(Value)
        ...
        if not Value then
            ...
            createNotif("RTaO", "Deer ESP Off", 2)
        else
            createNotif("RTaO", "Deer ESP On", 2)
            scanForDeerHead()
        end
    end
})
...
local TeammatesESPToggle = Tabs.Esp:AddToggle("TeammatesESP", {
    ...
    Callback = function(Value)
        ...
        if not Value then
            ...
            createNotif("RTaO", "Teammates ESP Off", 2)
        else
            createNotif("RTaO", "Teammates ESP On", 2)
            scanForTeammates()
        end
    end
})
...
local BearESPToggle = Tabs.Esp:AddToggle("BearESP", {
    ...
    Callback = function(Value)
        ...
        if not Value then
            ...
            createNotif("RTaO", "Bear ESP Off", 2)
        else
            createNotif("RTaO", "Bear ESP On", 2)
            scanForBears()
        end
    end
})
...
local ChildrenESPToggle = Tabs.Esp:AddToggle("ChildrenESP", {
    ...
    Callback = function(Value)
        ...
        if not Value then
            ...
            createNotif("RTaO", "Children ESP Off", 2)
        else
            createNotif("RTaO", "Children ESP On", 2)
            scanForChildren()
        end
    end
})
...
local CultistESPToggle = Tabs.Esp:AddToggle("CultistESP", {
    ...
    Callback = function(Value)
        ...
        if CultistESPEnabled then
            createNotif("RTaO", "Cultist Esp On", 2)
            ...
            createNotif("RTaO", "Cultist Esp Off", 2)
            removeAllCultistESP()
        end
    end
})
...
local AlphaWolfESPToggle = Tabs.Esp:AddToggle("AlphaWolfESP", {
    ...
    Callback = function(Value)
        ...
        if AlphaWolfESPEnabled then
            createNotif("RTaO", "Alpha Wolf Esp On", 2)
            ...
            createNotif("RTaO", "Alpha Wolf Esp Off", 2)
...
local PolarBearESPToggle = Tabs.Esp:AddToggle("PolarBearESP", {
    ...
    Callback = function(Value)
        ...
        if PolarBearESPEnabled then
            ...
            createNotif("RTaO", "Polar Bear Esp Off", 2)
...
local GetChild1Button = AutoChildSection:AddButton({
    ...
    Callback = function()
        if isGetChildrenActive then
            createNotif("RTaO", "Wait!", 0.2)
            return
        end
        
        isGetChildrenActive = true
        createNotif("RTaO", "Going to Jail Cellar1...", 0.2)
            ...
            local success, err = pcall(function()
                ...
                if cellar1 then
                    ...
                    if teleportSuccess then
                        createNotif("RTaO", "Sack the Kid", 0.2)
                        task.wait(4)
                        
                        local spawnPos = getSpawnLocation()
                        if spawnPos then
                            safeTeleport(spawnPos)
                            createNotif("RTaO", "Returned from Jail Cellar1!", 0.2)
                        end
                    else
...
local GetChild2Button = AutoChildSection:AddButton({
    ...
    Callback = function()
        ...
        isGetChildrenActive = true
        createNotif("RTaO", "Going to Jail Cellar2...", 0.2)
        ...
        task.spawn(function()
            local success, err = pcall(function()
                ...
                if cellar2 then
                    ...
                    if teleportSuccess then
                        createNotif("RTaO", "Sack it fast", 0.2)
                        task.wait(4)
                        
                        local spawnPos = getSpawnLocation()
                        if spawnPos then
                            safeTeleport(spawnPos)
                            createNotif("RTaO", "Returned from Jail Cellar2!", 0.2)
                        end
                    else
                        createNotif("Error", "Not Found try finding child first", 0.2)
                    end
...
local GetChild3Button = AutoChildSection:AddButton({
    ...
    Callback = function()
        if isGetChildrenActive then
            createNotif("RTaO", "Wait!", 2)
            return
        end
        
        isGetChildrenActive = true
        createNotif("RTaO", "Going to Jail Cellar3...", 2)
        ...
        task.spawn(function()
            local success, err = pcall(function()
                ...
                if cellar3 then
                    ...
                    if teleportSuccess then
                        createNotif("RTaO", "Sack the Kid!", 2) -- FIXED: Added missing parenthesis
                        task.wait(4)
                        
                        local spawnPos = getSpawnLocation()
                        if spawnPos then
                            safeTeleport(spawnPos)
                            createNotif("RTaO", "Returned from Jail Cellar3!", 2) -- FIXED: Added missing parenthesis
                        end
                    else
...
local GetChild4Button = AutoChildSection:AddButton({
    ...
    Callback = function()
        ...
        isGetChildrenActive = true
        createNotif("RTaO", "Going to Jail Cellar4...", 0.2)
        ...
        task.spawn(function()
            local success, err = pcall(function()
                ...
                if cellar4 then
                    ...
                    if teleportSuccess then
                        createNotif("RTaO", "At Jail Cellar4 - Get the child!", 0.2)
                        task.wait(4)
                        
                        local spawnPos = getSpawnLocation()
                        if spawnPos then
                            safeTeleport(spawnPos)
                            createNotif("RTaO", "failed to return??", 1)
                        end
                    else
...
local function applySpeed()
    ...
    if humanoid then
        humanoid.WalkSpeed = speedValue
        createNotif("RTaO", "Speed set to " .. speedValue, 2)
    else
...
local function resetSpeed()
    ...
    if humanoid then
        ...
        createNotif("RTaO", "Speed reset to default", 2)
    end
end
...
local function disableNoclip()
    ...
    createNotif("RTaO", "Noclip disabled", 2)
end
...
local function enableInfiniteJump()
    ...
    createNotif("RTaO", "Infinite Jump enabled", 2)
end
...
local function disableInfiniteJump()
    ...
    createNotif("RTaO", "Infinite Jump disabled", 2)
end
    ...
    Callback = function(Value)
        ...
        if speed and speed >= 0 and speed <= 10000 then
            ...
            if isSpeedApplied then
                ...
                createNotif("RTaO", "Speed set to " .. speed .. " Turn on the toggle to apply", 2)
            end
        else
...
local DisableCampFireToggle = Tabs.Vision:AddToggle("DisableCampFire", {
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            createNotif("RTaO", "CampFire Effect Disabled", 2)
        else
            -- Restore original bloom
            if originalBloom then
                originalBloom.Enabled = true
            ...
            createNotif("RTaO", "CampFire Effect Enabled", 2)
        end
    end
})
...
local function createMobileToggle()
    local success, err = pcall(function()
        ...
        local existing = playerGui:FindFirstChild("RTaOToggle")
        if existing then
            existing:Destroy()
        end
